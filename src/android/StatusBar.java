...
public class StatusBar extends CordovaPlugin {
    ...
    public boolean execute(final String action, final CordovaArgs args, final CallbackContext callbackContext) {
        ...
        switch (action) {
            ...
            case "isStatusBarOverlayingWebview":
                boolean isStatusBarVisible = (window.getAttributes().flags & WindowManager.LayoutParams.FLAG_FULLSCREEN) == 0;
                callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK, doOverlay && isStatusBarVisible));
                return true;
